...
const questions = [
    ...
    },
    {
        ...
        "options": [
            ...
            "The LLM needs to be frequently fine-tuned with the new documents in order to provide most up-to-date answers.",
